      ...
      <div className="border border-yellow-500/20 bg-slate-900/30 backdrop-blur-xl rounded-lg">
        <div className="p-4">
          ...
          <dl className="grid grid-cols-2 gap-4">
            ...
            >
              <dd className="text-2xl font-bold text-purple-300">{wordCount}</dd>
              <dt className="text-xs text-purple-400">Words</dt>
            </motion.div>
            <motion.div
              className="text-center p-3 bg-blue-600/10 border border-blue-500/30 rounded-lg"
              whileHover={{ scale: 1.05 }}
            >
              <dd className="text-2xl font-bold text-blue-300">{charCount}</dd>
              <dt className="text-xs text-blue-400">Characters</dt>
            </motion.div>
            <motion.div
              className="text-center p-3 bg-green-600/10 border border-green-500/30 rounded-lg"
              whileHover={{ scale: 1.05 }}
            >
              <dd className="text-2xl font-bold text-green-300">{minRead}</dd>
              <dt className="text-xs text-green-400">Min Read</dt>
            </motion.div>
            <motion.div
              className="text-center p-3 bg-yellow-600/10 border border-yellow-500/30 rounded-lg"
              whileHover={{ scale: 1.05 }}
            >
              <dd className="text-2xl font-bold text-yellow-300">A+</dd>
              <dt className="text-xs text-yellow-400">AI Ready</dt>
            </motion.div>
          </dl>
        </div>
      </div>
