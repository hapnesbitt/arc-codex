// Filename: /frontend/app/library/shelves/page.tsx
// Library — curated shelves index. Server Component.
...
export const metadata: Metadata = {
  title: 'Curated Shelves — Arc Codex Library',
  description: 'Themed collections of public-domain works drawn from Project Gutenberg bookshelves.',
};
...
export default async function LibraryShelvesPage() {
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="text-center py-12 border-b border-slate-800/60 space-y-4">
          ...
          <p className="font-serif text-lg text-slate-400 italic leading-relaxed max-w-xl mx-auto">
            Themed collections drawn from the Gutenberg canon.
          </p>
