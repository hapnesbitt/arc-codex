    ...
    <PageWrapper>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-12">
            ...
            <div className="bg-green-900/10 border border-green-500/30 rounded-lg p-6 mt-6">
              ...
              <ul className="space-y-3 text-slate-300">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>No personally identifiable information required</span>
                </li>
              </ul>
            </div>
          </Section>
          ...
          >
            <p>
              We do not require registration, collect personally identifiable information (PII), or use cookies for tracking. 
              You can browse anonymously without sharing personal details.
            </p>
