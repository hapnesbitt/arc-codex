...
text, duration = call_ollama_with_fallback(prompt, model)`}</Block>
          <p className="font-serif text-base text-slate-200 leading-relaxed">
            Models: <Code>devstral</Code> (cloud, primary) → <Code>gemma3:4b</Code> (local M1, fallback). gemma3:4b handles simple tasks but struggles with large JSON translation payloads. Translation failures on 429 are graceful — &ldquo;model unavailable&rdquo; is shown to the user.
          </p>
          <Warn>
