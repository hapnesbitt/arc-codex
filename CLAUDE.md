...
- **Cloud model**: `gemma4:31b-cloud` (weekly credit limit; devstral-2:123b-cloud and qwen3-coder:480b-cloud both retired 2026-07-15). Chosen for cloud→local family consistency — same gemma lineage as the `gemma4:e2b` local fallback.
